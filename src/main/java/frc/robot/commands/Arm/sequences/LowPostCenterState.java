...
public class LowPostCenterState extends CommandBase {
  enum State {
    INIT,
  ...
  ArmToPreset m_extendArm = new ArmToPreset(0, 13.8, -73, -155.4, false, true, true, true);

  private boolean m_isFinished;
  private State m_state;
  /** Creates a new ReachForNextBarStatefully. */
  public LowPostCenterState() {
  ...
  public static void registerWithTestingDashboard() {
    ...
    LowPostCenterState cmd = new LowPostCenterState();
