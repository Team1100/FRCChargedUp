...
public class HighPostCenterState extends CommandBase {
  ...
  ArmToPreset m_extendElbow = new ArmToPreset(0, 0, -145.5, 0, false, false, true, false);
  ArmToPreset m_extendArm = new ArmToPreset(0, 45, -145.5, -122, false, true, true, true);
