...
public class ConeFarPostStraightSequence extends SequentialCommandGroup {
   ...
   * @param wristAngle
   */
  public ConeFarPostStraightSequence() {
    ...
    addCommands(
      new ArmToPreset(0, 0, -125, -105),
      new ArmToPreset(0, 44, -125, -105)
  ...
  public static void registerWithTestingDashboard() {
    ...
    ConeFarPostStraightSequence cmd = new ConeFarPostStraightSequence();
