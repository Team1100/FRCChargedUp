...
public class ConeLowPostCenterSequence extends SequentialCommandGroup {
   ...
   * @param wristAngle
   */
  public ConeLowPostCenterSequence() {
    ...
    addCommands(
      new ArmToPreset(0, 0, -71, -135),
      new ArmToPreset(0, 31, -71, -135)
