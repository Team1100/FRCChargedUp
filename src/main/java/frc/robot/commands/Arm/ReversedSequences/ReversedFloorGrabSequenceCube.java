...
public class ReversedFloorGrabSequenceCube extends SequentialCommandGroup {
   ...
   * @param wristAngle
   */
  public ReversedFloorGrabSequenceCube() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    
    //TODO: figure out exactly what operators want and reprogram to match
    addCommands(
        new ArmToPreset(0, -49, 28, -178, false, true, true, true)
    );
  }

  public static void registerWithTestingDashboard() {
    Arm arm = Arm.getInstance();
    ReversedFloorGrabSequenceCube cmd = new ReversedFloorGrabSequenceCube();
