...
package frc.robot.commands.Arm.ReversedSequences;
...
public class ReversedFloorGrabSequenceCone extends SequentialCommandGroup {
   ...
   * @param wristAngle
   */
  public ReversedFloorGrabSequenceCone() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    
    //TODO: figure out exactly what operators want and reprogram to match
    addCommands(
        new ArmToPreset(0, -30, 29.5, -164, false, true, true, true)
    );
  }

  public static void registerWithTestingDashboard() {
    Arm arm = Arm.getInstance();
    ReversedFloorGrabSequenceCone cmd = new ReversedFloorGrabSequenceCone();
