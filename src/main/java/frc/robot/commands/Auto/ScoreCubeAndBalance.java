...
public class ScoreCubeAndBalance extends CommandBase {
  enum State {
    INIT,
    SCHEDULE_EXTEND_ARM,
    EXTEND_ARM,
  ...
  public ScoreCubeAndBalance(double driveBackDistance, double secondBackDistance, double power) {
  ...
  public static void registerWithTestingDashboard() {
    ...
    ScoreCubeAndBalance cmd = new ScoreCubeAndBalance(0,0,0);
